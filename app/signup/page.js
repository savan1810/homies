                ...
                <div className='  z-10 flex   lg:w-2/3  justify-center items-center mx-auto  '>
                    <div className='bg-white border px-4 py-4 my-10 mx-auto   shadow-xl rounded-2xl flex-col items-center justify-center z-10 '>
                        ...
                        <form className="mt-2 mx-auto flex-col justify-center items-center ">
                            ...
                            <input type="text" id="name" className="hover:border-black outline-none w-full px-3 py-2 border  border-gray-300 rounded-md mb-2" placeholder="John" />
                            <label for="email" className="font-medium opacity-90  ">Email<span className="text-red-500 align-top">*</span></label><br />
                            <input type="email" id="email" placeholder="abc@gmail.com" className="hover:border-black outline-none w-full px-3 py-2 border  border-gray-300 rounded-md mb-2" />

                            <label for="phone" className="font-medium opacity-90  ">Phone<span className="text-red-500 align-top">*</span></label><br />
                            <input type="text" id="phone" className=" hover:border-black outline-none w-full px-3 py-2 border  border-gray-300 rounded-md mb-2" placeholder="+91 1234567890" />
                            <label for="address" className="font-medium opacity-90  ">Address<span className="text-red-500 align-top">*</span></label><br />
                            <input type="text" id="address" className=" hover:border-black outline-none w-full px-3 py-2 border  border-gray-300 rounded-md mb-2" placeholder="India" />


                            <label for="country" className="font-medium opacity-90  ">Country<span className="text-red-500 align-top">*</span></label><br />
                            <input type="text" id="country" className=" hover:border-black outline-none w-full px-3 py-2 border  border-gray-300 rounded-md mb-2" placeholder="India" />
                            <label for="School" className="font-medium opacity-90  ">School<span className="text-red-500 align-top">*</span></label><br />
                            <input type="text" id="School" placeholder="abc" className=" hover:border-black outline-none w-full border-gray-300 px-3 py-2  border rounded-lg mb-2" />
                            <label for="line" className="font-medium opacity-90  ">Line at school<span className="text-red-500 align-top">*</span></label><br />
                            <input type="text" id="line" className=" hover:border-black outline-none w-full px-3 py-2 border  border-gray-300 rounded-md mb-2 text-left" placeholder="Computer Enginnering" />
                            ...
                            <div className='border hover:border-black rounded-md py-[3px] mb-2  flex items-center'>

                                <Button component="label" variant="" className="flex justify-start    hover:border-black hover:bg-white  text-gray-400 rounded-md" startIcon={<CloudUploadIcon className='text-gray-400'
                                />}>
                                    <span className='text-gray-400 capitalize font-normal text-base tracking-normal'>Upload file</span>
                            ...
                            <div className='border hover:border-black rounded-md py-[3px] mb-2  flex items-center'>
                                ...
                                <Button component="label" variant=""  className=" flex justify-start   hover:border-gray-200 hover:bg-white  text-gray-400 rounded-md" startIcon={<CloudUploadIcon className='text-gray-400'
                                />}>
                                                                        <span className='text-gray-400 capitalize font-normal text-base tracking-normal'>Upload file</span>
