...
const Page = () => {
    return (
        <div>
            ...
            <div className="flex items-center justify-center min-h-screen  ">
                ...
                <div className="flex flex-col bg-gradient-to-r from-[#EBE3D5] to-[#F3EEEA]">
                    ...
                    <div className="flex flex-col mt-8 ">
                        ...
                        <div className="container max-w-7xl mx-auto px-4 ">
                            ...
                            <div className="relative mx-auto max-w-5xl text-center">
                                <span className="text-[#343f52] my-3 text-3xl flex items-center justify-center font-medium ">
                                    Meet Our Team
                                </span>
                                ...
                                <div className="w-full md:w-6/12 lg:w-3/12 mb-6 px-6 sm:px-6 lg:px-4">
                                    <div className="flex flex-col">
                                        ...
                                        <div className="text-center mt-6">
                                            <h1 className="text-[#343f52] text-xl font-semibold mb-1">
                            ...
                            <div className='  w-[4/5] mx-auto'>
                                <p className='text-[#343f52]  text-base text-center'>
                    ...
                    <div className="">
                        <section id="features"
                            ...
                            <div className="relative mx-auto max-w-5xl text-center">
                                <span className="text-[#343f52] my-3 text-3xl flex items-center justify-center  ">
                                    About <span className='text-[#343f52] ml-2 font-medium'>HOMIES</span>
                                </span>
                            ...
                            <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
                                <div className=" p-8 text-center border border-gray-400/40" style={{borderRadius: "20px",
    border: "",
    ...
    backgroundColor: "rgb(251, 252, 253)"}}>
                                    ...
                                    <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-600">We prioritize the safety and quality of home exchanges through carefully selected security measures and quality checks.This ensures that our users cn trust that they are exchaning homes with dependaple partners and receive the support they need throughtout the process.
                                    </p>
                                </div>
